...
| ---- | ---------- | ----------------------------------------------------- | -------------------------- |
| 看见 | kàn jiàn   | to see                                                |                            |
| 分   | fēn        | to divide, to separate, part, share                   | ![分](Stroke_order/分.png) |
| 钟   | zhōng      | clock, o'clock, time as measured in hours and minutes | ![钟](Stroke_order/钟.png) |
| 分钟 | fēn zhōng  | minute                                                |                            |
| 回   | huí        | to circle, to go back, to turn around                 | ![回](Stroke_order/回.png) |
| 来   | lái        | to come, to arrive                                    | ![来](Stroke_order/来.png) |
| 回来 | huí lai    | to return, to come back                               |                            |
| 先   | xiān       | early, prior, former, in advance, first               | ![先](Stroke_order/先.png) |
...
| 衣   | yī         | clothes, to dress, to wear, to put on | ![衣](Stroke_order/衣.png) |
| 服   | fu         | clothes, dress, garment               | ![服](Stroke_order/服.png) |
| 衣服 | yī fu      | clothes                               |                            |
| 漂   | piào       | elegant, polished                     | ![漂](Stroke_order/漂.png) |
| 亮   | liàng      | bright, clear, resonant, to shine     | ![亮](Stroke_order/亮.png) |
...
| 这些 | zhè xiē | these                |                            |
| 都   | dōu     | all, both, entirely  | ![都](Stroke_order/都.png) |
